<%@ page import="servlet.AddUserServlet" %>
...
<div class="right">
    ...
    <div class="search">
        <form method="get" action="SelectUserServlet">
...
<%--            <th width="30%">操作</th>--%>
        ...
        <tr>
            ...
            <td>
                ...
                <span><a class="modifyUser" href="/jsp/updateuser.jsp"><img
                        src="/images/xiugai.png" alt="修改" title="修改"/></a></span>
                <span><a class="deleteUser" href="/jsp/deleteuser?id=<%=users.getId()%>"><img
